module Xbar #(parameter XLEN = 32, ADDR_WIDTH = 27)
(
    input logic                  clk,
    input logic                  rst_n,
    ...
    localparam PMEM_SIZE = 32'h0010_0000; // 1MB
    ...
    assign m_respValid = ram_respValid;
    assign m_reqReady = ram_reqReady;
    assign m_err = ram_err;
endmodule
